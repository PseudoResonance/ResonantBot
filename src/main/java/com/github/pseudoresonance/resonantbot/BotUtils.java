...
public class BotUtils {
	...
	static IDiscordClient getBuiltDiscordClient(String token) {
		...
		IDiscordClient client = new ClientBuilder().withToken(token).withRecommendedShardCount().setPresence(StatusType.ONLINE, ActivityType.LISTENING, ResonantBot.getStatusMessage()).build();
		return client;
	}
